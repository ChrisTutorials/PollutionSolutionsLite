...
function tests.test_makeNewDataFromData()
  ...
  TestUtils.assertEqual(data.raw["item"]["iron-plate"].name, "iron-plate", "Original should not change")
end

function tests.test_makeNewEntityFromData()
  local newEntity = makeNewEntityFromData("assembling-machine", "assembling-machine-1", "my-machine", "z")
...
function tests.test_makeNewEntityFromData_default_order()
  local newEntity = makeNewEntityFromData("assembling-machine", "assembling-machine-1", "my-machine")
