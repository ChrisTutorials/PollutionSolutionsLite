...
function tests.test_setDirectionalGraphics_north()
  ...
  TestUtils.assertEqual(structure.north.layers[1].filename, "test-N.png", "Should set north filename")
end
...
function tests.test_setDirectionalGraphics_missing_direction_fails()
  ...
  TestUtils.assert(string.find(err, "Structure.north.layers not found"), "Should have meaningful error message")
end
...
function tests.test_setAllDirectionalGraphics()
  ...
  TestUtils.assertEqual(structure.north.layers[1].filename, 
    GRAPHICS .. "entity/test/lowheatex-N-idle.png", "Should set north filename")
  TestUtils.assertEqual(structure.east.layers[1].filename, 
    GRAPHICS .. "entity/test/lowheatex-E-idle.png", "Should set east filename")
  TestUtils.assertEqual(structure.south.layers[1].filename, 
    GRAPHICS .. "entity/test/lowheatex-S-idle.png", "Should set south filename")
  TestUtils.assertEqual(structure.west.layers[1].filename, 
    GRAPHICS .. "entity/test/lowheatex-W-idle.png", "Should set west filename")
end
...
function tests.test_setAllDirectionalGraphics_with_hr_versions()
  ...
  TestUtils.assertNotNil(structure.north.layers[1].hr_version.filename, "Should set north HR filename")
  TestUtils.assertNotNil(structure.east.layers[1].hr_version.filename, "Should set east HR filename")
  TestUtils.assertNotNil(structure.south.layers[1].hr_version.filename, "Should set south HR filename")
  TestUtils.assertNotNil(structure.west.layers[1].hr_version.filename, "Should set west HR filename")
end
...
function tests.test_setAllDirectionalGraphics_missing_direction_fails()
  ...
  TestUtils.assert(string.find(err, "Structure.west.layers not found"), "Should indicate which direction is missing")
end
...
function tests.test_setAllDirectionalGraphics_nil_structure_fails()
  ...
  TestUtils.assert(string.find(err, "Structure cannot be nil"), "Should have meaningful error message")
end
